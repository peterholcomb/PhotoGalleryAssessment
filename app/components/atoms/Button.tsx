...
const $viewPresets = {
  ...
  danger: [$baseViewStyle, { backgroundColor: colors.palette.angry500 }],
}
...
const $pressedViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
  default: { backgroundColor: colors.palette.primary400 },
  filled: { backgroundColor: colors.palette.primary400 },
  reversed: { backgroundColor: colors.palette.neutral700 },
  danger: { backgroundColor: colors.palette.angry600 },
}
