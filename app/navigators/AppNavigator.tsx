...
const AppStack = observer(function AppStack() {
  return (
    ...
    >
      ...
      <Stack.Screen
        name="EditPhotos"
        component={Screens.EditPhotosScreen}
        options={{
          headerTitle: translate("editPhotosScreen.title"),
        }}
      />

      <Stack.Screen
        name="AddPhotos"
        component={Screens.AddPhotosScreen}
        options={{
          headerTitle: translate("addPhotosScreen.title"),
        }}
      />
    </Stack.Navigator>
  )
